...
export default function MemePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-orange-500 to-red-500 dark:from-orange-700 dark:to-red-700 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-4 mb-6">
            <Laugh className="w-12 h-12" />
            <h1 className="text-5xl font-bold">Meme Collection</h1>
            <Laugh className="w-12 h-12" />
          </div>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Spread the laughs with our hilarious meme-inspired designs. From
            viral sensations to timeless classics!
          </p>
